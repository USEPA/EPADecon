...
namespace Battelle.EPA.WideAreaDecon.Model
{
	public class LaborCostCalculator
	{
		...
		public LaborCostCalculator(double numTeams, double personnelOverhead, double numEntriesPerTeamPerDay, double hoursPerEntryPerTeam, double hoursPerExitPerTeam)
		{
			NumTeams = numTeams;
