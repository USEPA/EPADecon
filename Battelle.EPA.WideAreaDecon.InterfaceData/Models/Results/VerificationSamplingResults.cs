...
{
    public class VerificationSamplingResults
    {
        ...
        public static VerificationSamplingResults SumResults(List<VerificationSamplingResults> segmentResults)
        {
            return new VerificationSamplingResults()
            {
        ...
        private static Dictionary<PpeLevel, int> SumPPEUnits(List<VerificationSamplingResults> segmentResults)
        {
