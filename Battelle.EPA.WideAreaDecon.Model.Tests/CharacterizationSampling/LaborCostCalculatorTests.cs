...
namespace Battelle.EPA.WideAreaDecon.Model.Tests.CharacterizationSampling
{
    ...
    public class LaborCostCalculatorTests
    {
        ...
        public void CalculateCost()
        {
            ...
            Assert.AreEqual(115407.74958828, Calculator.CalculateLaborCost(workDays, _numberTeams, roundtripDays, fractionSampledWipe, fractionSampledHepa, areaContaminated), 1e-4,
                "Incorrect labor cost calculated");
            Assert.AreEqual(102687.74958828, Calculator.CalculateEntExitLaborCost(workDays, _numberTeams, fractionSampledWipe, fractionSampledHepa, areaContaminated), 1e-4,
                "Incorrect ent/exit labor cost calculated");
            Assert.AreEqual(4.53646814419341, Calculator.CalculateLaborDays(workDays), 1e-4,
