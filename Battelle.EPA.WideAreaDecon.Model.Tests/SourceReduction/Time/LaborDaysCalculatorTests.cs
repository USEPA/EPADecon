...
namespace Battelle.EPA.WideAreaDecon.Model.Tests.SourceReduction.Time
{
    public class LaborDaysCalculatorTests
    {
        ...
        {
            var numberTeams = 4.0;
            var massToBeSourceReduced = 1.0;
            var area = 3000.0;

            Assert.AreEqual(1.019638794335, Calculator.CalculateLaborDays(numberTeams, massToBeSourceReduced, area), 1e-6, "Incorrect labor days calculated");
        }
    }
}
