  ...
  getNavigationItems(): INavigationItem[] {
    return [
      new NavigationItem(
        ...
        () => {
          return store.state.PARAMETER_SELECTION.scenarioDefinition.numberInvalidParameters();
        },
      ),
      new NavigationItem(
        'Modify Parameters',
        ...
        () => {
          return store.state.PARAMETER_SELECTION.scenarioParameters.numberInvalidParameters();
        },
      ),
      new NavigationItem(
        'View Results',
