<template>
  <v-container>
    <v-container v-if="currentSelectedParameter.path != 'Extent of Contamination - Area Contaminated'">
    ...
    <geospatial-display v-if="currentSelectedParameter.path == 'Extent of Contamination - Area Contaminated'" />
  </v-container>
</template>
